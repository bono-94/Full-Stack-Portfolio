...
urlpatterns = [
    ...
    # POST PRIVATE
    path('my-post', views.UserPosts.as_view(), name='user_posts_list'),
    path('my-post/<slug:slug>', views.PostDetailDraft.as_view(), name='user_post_details_1_landing'),
    path('my-post/<slug:slug>/details', views.PostDetailOppsDraft.as_view(), name='user_post_details_2_opps'),
    path('my-post/<slug:slug>/about-us', views.PostDetailAboutUsDraft.as_view(), name='user_post_details_3_about_us'),
    path('my-post/<slug:slug>/body', views.PostDetailBodyDraft.as_view(), name='user_post_details_4_body'),
    path('my-post/<slug:slug>/files', views.PostDetailFilesDraft.as_view(), name='user_post_details_5_files'),
    path('my-post/<slug:slug>/proposal', views.PostDetailProposalDraft.as_view(), name='user_post_details_6_proposal'),
    path('vote/<slug:slug>', views.PostVote.as_view(), name='vote'),
    path('create-post', views.PostCreate.as_view(), name='user_post_create'),
    path('my-post/edit/<int:post_id>/', views.post_edit, name='post_edit'),
