...
urlpatterns = [
    ...
    path('projects/<slug:slug>', views.PostDetail.as_view(), name='public_post_details_1_main'),
    path('projects/<slug:slug>', views.PostDetail.as_view(), name='public_post_details_2_opps'),
