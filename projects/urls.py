...
urlpatterns = [
    ...
    path('my-posts/<slug:slug>', views.PostDetailDraft.as_view(), name='user_post_details_1_landing'),
    path('my-posts/<slug:slug>/details', views.PostDetailOppsDraft.as_view(), name='user_post_details_2_opps'),
    path('my-posts/<slug:slug>/about-us', views.PostDetailAboutUsDraft.as_view(), name='user_post_details_3_about_us'),
    path('my-posts/<slug:slug>/body', views.PostDetailBodyDraft.as_view(), name='user_post_details_4_body'),
    path('my-posts/<slug:slug>/files', views.PostDetailFilesDraft.as_view(), name='user_post_details_5_files'),
    path('my-posts/<slug:slug>/proposal', views.PostDetailProposalDraft.as_view(), name='user_post_details_6_proposal'),
